...
impl Lease {
    ...
    pub fn payload(&self) -> String {
        ...
        format!(
            "v3|{}|{}|{}|{}|{}|{}|{}",
            self.kid, self.license_key_hash, self.instance_id,
            self.issued_at, self.expires_at, self.status, ents.join(",")
        )
    }
}
...
mod tests {
    ...
    fn payload_sorts_entitlements_and_matches_v3_format() {
        let l = Lease {
            kid: "k1".into(), license_key_hash: "abc".into(), instance_id: "i1".into(),
            issued_at: 100, expires_at: 200, status: "active".into(),
            signature: "sig".into(), entitlements: vec!["pro".into(), "admin".into()],
        };
    ...
    fn payload_empty_entitlements_is_trailing_empty() {
        let l = Lease {
            kid: "k1".into(), license_key_hash: "abc".into(), instance_id: "i1".into(),
            issued_at: 100, expires_at: 200, status: "active".into(),
            signature: "sig".into(), entitlements: vec![],
        };
